      ...
      <AnimatePresence>
        {isObserving && (
          <motion.g
            ...
            transition={{ duration: 0.5, ease: "easeOut" }}
          >
            {/* The Dog (Positioned behind or in front of stickman depending on direction) */}
            <motion.g 
              transform={direction === -1 ? "translate(80, 80) scale(-1, 1)" : "translate(-40, 80)"}
            ...
            {/* The Cat */}
            <motion.g 
              transform={direction === -1 ? "translate(-40, 85) scale(-1, 1)" : "translate(100, 85)"}
              animate={{ y: [0, -2, 0] }}
