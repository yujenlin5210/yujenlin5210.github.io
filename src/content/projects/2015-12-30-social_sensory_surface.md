...
<h2 class="my-8">Technology-embedded multi-sensory environments for children with autism spectrum disorder</h2>
<p class="my-4 text-slate-500 italic">Excerpted from the principal investigator, <a href="http://www.materialarchitectures.com/social-sensory/">Sean Ahlquist's website</a>:</p>

<blockquote class="my-8 border-l-4 border-slate-200 dark:border-white/10 pl-6 italic text-slate-600 dark:text-slate-400 space-y-4">
...
<h2 class="my-8">Software and Sensing Technology</h2>
<p class="my-8">
